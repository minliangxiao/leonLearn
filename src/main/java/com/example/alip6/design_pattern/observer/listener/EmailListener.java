...
/**
 * 依据spring 来实现回调机制这个类相当于原来的 EmailObserver+MysubJect类
 */
@Component
public class EmailListener implements ApplicationListener<UserMessageEntiy> {
    ...
    public void onApplicationEvent(UserMessageEntiy userMessageEntiy) {
        System.out.println("邮件："+userMessageEntiy.toString());
    }
}
